...
test("can search Google twice", async () => {
  ...
  await driver.findElement(By.name('q')).sendKeys("orange juice", Key.RETURN);
  await driver.wait(until.titleIs("orange juice - Google Search"), 1000);
  ...
  await driver.findElement(By.name('q')).sendKeys("skateboard", Key.RETURN);
  // TODO Wait for the results page to load
  await driver.wait(until.titleIs("skateboard - Google Search"), 1000);
});
